...
return [
    ...
    /**
     * Easily change the identification method in a single place,
     * just make sure to use the generic identifier with the middleware class
