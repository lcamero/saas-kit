...
<div class="flex flex-col gap-6">
    <x-auth-header :title="__(__('auth.forgot_password'))" :description="__('auth.enter_email_to_receive_password_reset_link')" />
    ...
    <div class="space-x-1 rtl:space-x-reverse text-center text-sm text-zinc-400">
        ...
        <flux:link :href="route('login')" wire:navigate>{{ __('general.log_in') }}</flux:link>
    </div>
</div>
